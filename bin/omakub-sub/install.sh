CHOICES=(
	...
	"Bitwarden     Manage your passwords securely across devices free"
	...
	"WebStorm      IntelliJ's free Javascript editor"
	"PhpStorm      IntelliJ's commercial PHP editor"
	"RustRover     IntelliJ's commercial Rust editor"
	"GoLand        IntelliJ's commercial Go editor"
